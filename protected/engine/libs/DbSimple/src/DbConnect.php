...
class DbConnect
{
    ...
    public static function get($dsn)
    {
        ...
        return isset($pool[$dsn]) ? $pool[$dsn] : $pool[$dsn] = new static($dsn);
    }
    ...
    public function __call($method, $params)
    {
        ...
        return call_user_func_array([$this->DbSimple, $method], $params);
    }
    ...
    protected function connect($dsn)
    {
        ...
        $this->DbSimple = DbSimple::connect($dsn);
        ...
        if (!$this->DbSimple || $this->error) {
            ...
            foreach ($this->init as $query) {
                call_user_func_array([$this->DbSimple, 'query'], $query);
            }
            $this->init = [];
        }
    }
    ...
    public function selectPage(&$total, $query)
    {
        ...
        return call_user_func_array([$this->DbSimple, 'selectPage'], $args);
    }
