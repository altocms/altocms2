    ...
    public function validate($sValue) {
        ...
        switch ($this->operator) {
            ...
            case '==':
                if (($this->strict && $sValue !== $sCompareValue) || (!$this->strict && $sValue != $sCompareValue)) {
                    return $this->getMessage(
                        \E::Module('Lang')->get('validate_compare_must_repeated', null, false), 'msg',
            ...
            case '!=':
                if (($this->strict && $sValue === $sCompareValue) || (!$this->strict && $sValue == $sCompareValue)) {
                    return $this->getMessage(
                        \E::Module('Lang')->get('validate_compare_must_not_equal', null, false), 'msg',
            ...
            case '>':
                if ($sValue <= $sCompareValue) {
                    return $this->getMessage(
                        \E::Module('Lang')->get('validate_compare_must_greater', null, false), 'msg',
                        array('compare_field' => $sCompareLabel, 'compare_value' => htmlspecialchars($sCompareValue))
                    );
                }
                break;
            case '>=':
                if ($sValue < $sCompareValue) {
                    return $this->getMessage(
                        \E::Module('Lang')->get('validate_compare_must_greater_equal', null, false), 'msg',
                        array('compare_field' => $sCompareLabel, 'compare_value' => htmlspecialchars($sCompareValue))
                    );
                }
                break;
            case '<':
                if ($sValue >= $sCompareValue) {
                    return $this->getMessage(
                        \E::Module('Lang')->get('validate_compare_must_less', null, false), 'msg',
                        array('compare_field' => $sCompareLabel, 'compare_value' => htmlspecialchars($sCompareValue))
                    );
                }
                break;
            case '<=':
                if ($sValue > $sCompareValue) {
                    return $this->getMessage(
                        \E::Module('Lang')->get('validate_compare_must_less_equal', null, false), 'msg',
                        array('compare_field' => $sCompareLabel, 'compare_value' => htmlspecialchars($sCompareValue))
                    );
                }
                break;
            default:
                return $this->getMessage(
                    \E::Module('Lang')->get('validate_compare_invalid_operator', null, false), 'msg',
