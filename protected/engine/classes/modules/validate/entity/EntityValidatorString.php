    ...
    public function validate($sValue) {
        ...
        if (is_array($sValue)) {
            return $this->getMessage(
                \E::Module('Lang')->get('validate_string_too_short', null, false), 'msgTooShort', array('min' => $this->min)
            );
        }
        ...
        if ($this->max !== null && $iLength > $this->max) {
            return $this->getMessage(
                \E::Module('Lang')->get('validate_string_too_long', null, false), 'msgTooLong', array('max' => $this->max)
            );
        }
        if ($this->is !== null && $iLength !== $this->is) {
            return $this->getMessage(
                \E::Module('Lang')->get('validate_string_no_lenght', null, false), 'msg', array('length' => $this->is)
            );
        }
        return true;
    }
