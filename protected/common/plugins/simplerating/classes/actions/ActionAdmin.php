...
class PluginSimplerating_ActionAdmin extends PluginSimplerating_Inherit_ActionAdmin {
    ...
    public function EventRating() {
        ...
        E::Module('Viewer')->assign('sPageTitle', E::Module('Lang')->get('plugin.simplerating.admin_title'));
        E::Module('Viewer')->assign('sMainMenuItem', 'settings');
        E::Module('Viewer')->addHtmlTitle(\E::Module('Lang')->get('plugin.simplerating.admin_title'));
