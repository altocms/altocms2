...
alto.modal = (function ($) {
     ...
     * usage:
     *      alto.confirm('message', function() { });
     *      alto.confirm({title: 'title', message: 'message'}, function() { });
     *      alto.confirm({title: 'title', text: 'message'}, {onConfirm: function(){}});
     *      alto.confirm({title: 'title', html: 'message', onConfirm: function(){} });
     */
    this.alert = function () {
     ...
     * usage:
     *      alto.confirm('message', function(confirmed) { } );
     *      alto.confirm({title: 'title', message: 'message'}, function(confirmed) { });
     *      alto.confirm({title: 'title', message: 'message'}, {onConfirm: function(){}, onCancel: function() {} });
     *      alto.confirm({title: 'title', message: 'message', onConfirm: function(){}, onCancel: function() {} });
     *
    ...
    this.confirm = function(options, callback) {
        ...
        bootbox.dialog({
            ...
            buttons: {
                cancel: {
                    label: alto.lang.get('text_cancel'),
                    className: 'btn-default',
                    callback: onCancel
                },
                confirm: {
                    label: alto.lang.get('text_confirm'),
                    className: 'btn-primary',
                    callback: onConfirm
                }
            }
