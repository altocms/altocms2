...
ls.vote = (function ($) {
    ...
    var defaults = {
        ...
        type: {
            comment: {
                url: alto.routerUrl('ajax') + 'vote/comment/',
                targetName: 'idComment'
            },
            topic: {
                url: alto.routerUrl('ajax') + 'vote/topic/',
                targetName: 'idTopic'
            },
            blog: {
                url: alto.routerUrl('ajax') + 'vote/blog/',
                targetName: 'idBlog'
            },
            user: {
                url: alto.routerUrl('ajax') + 'vote/user/',
                targetName: 'idUser'
            }
        }
    };
    ...
    this.vote = function (targetType, targetId, voteValue, voteOption) {
        ...
        alto.progressStart();
        alto.ajax(target.url, params, function (response) {
            alto.progressDone();
    ...
    this.onVote = function (targetType, targetId, voteValue, voteOptions, response) {
        ...
        if (!response) {
            ...
            alto.msg.notice(null, response.sMsg);
