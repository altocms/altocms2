...
ls.userfield = ( function ($) {
    ...
    this.addFormField = function () {
        ...
        if (value) {
            ...
            alto.msg.error('', alto.lang.get('settings_profile_field_error_max', {count: this.iCountMax}));
        }
        return false;
    };
    ...
    this.changeFormField = function (button) {
        ...
        if (iCount > $that.iCountMax) {
            alto.msg.error('', alto.lang.get('settings_profile_field_error_max', {count: $that.iCountMax}));
        }
    };
