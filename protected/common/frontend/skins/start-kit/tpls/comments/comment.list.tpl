        ...
        <section class="comment">
            ...
            <ul class="list-unstyled list-inline small comment-info">
                ...
                <li class="comment-info-date">
                    <a href="{if C::get('module.comment.nested_per_page')}{router page='comments'}{else}{$oTopic->getUrl()}#comment{/if}{$oComment->getId()}" class="link-dotted" title="{$aLang.comment_url_notice}">
