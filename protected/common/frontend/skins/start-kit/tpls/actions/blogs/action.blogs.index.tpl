    ...
    <div class="content-inner-panel">
        ...
        <div class="panel panel-default flat">
            <ul class="nav nav-pills context-menu">
                <li class="bordered{if Router::getControllerAction()!='personal'} active{/if}"><a href="{router page='blogs'}">{$aLang.all_blogs}</a></li>
                <li class="bordered{if Router::getControllerAction()=='personal'} active{/if}"><a href="{router page='blogs'}personal">{$aLang.personal_blogs}</a></li>
            </ul>
