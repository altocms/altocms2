...
//$config['view']['header']['logo'] = C::get('path.skin.url') . 'themes/___view.theme___/img/favicon.png';
$config['view']['header']['logo'] = '___path.skin.dir___/themes/___view.theme___/img/favicon.png';
$config['view']['header']['name'] = 'START<span>KIT</span>';

// Aliases for sizes of user avatar
$config['module']['uploader']['images']['default']['size'] = [
    'large'  => 100,
    'big'    => 64,
    'medium' => 48,
    'small'  => 36,
...
$config['module']['uploader']['images']['profile_photo']['size'] = [
    'default'  => '250x250crop',
];
