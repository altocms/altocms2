...
class ModuleBlog_EntityBlogType extends Entity {
    ...
    public function init() {
        ...
        $this->aValidateRules[] = array(
            ...
            'label' => \E::Module('Lang')->get('action.admin.blogtypes_typecode'),
    ...
    protected function _getPropLangText($sLangKey, $sPropKey, $sDefault, $sLang = null) {
        ...
        if (is_null($sValue)) {
            $sValue = \E::Module('Lang')->get(str_replace('%%type_code%%', $this->getTypeCode(), $sLangKey));
            if (!$sValue) {
                $sValue = $sDefault;
            }
            if ($sValue && $sPropKey) {
    ...
    public function getNorder() {
        return (int)$this->getProp('norder');
    }
