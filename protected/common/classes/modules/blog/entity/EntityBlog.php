...
class ModuleBlog_EntityBlog extends Entity {
    ...
    public function getBlogType() {
        ...
        if (!$oBlogType && ($sType = $this->getType())) {
            $oBlogType = \E::Module('Blog')->getBlogTypeByCode($sType);
        }
        return $oBlogType;
    }
...
//        return $this->getProp('blog_avatar');
        ...
        return \E::Module('Uploader')->getTargetImageUrl('blog_avatar', $this->getId());
    }
    ...
    public function getProfileMedia($sType) {
        ...
        if (is_null($aMedia)) {
            ...
            $aImages = \E::Module('Uploader')->getImagesByUserAndTarget($this->getId(), $aTargetTypes);
            ...
            $aImages = \E::Module('Uploader')->getImagesByUserAndTarget($this->getId(), $sType);
            if (!empty($aImages[$this->getId()])) {
    ...
    public function getDefaultAvatarUrl($xSize = null) {
        ...
        $sPath = \E::Module('Uploader')->getUserAvatarDir(0) . 'avatar_blog_' . \C::get('view.skin', Config::LEVEL_CUSTOM) . '.png';
        $sResizePath = null;
        if ($xSize) {
            if ($sRealSize = C::get('module.uploader.images.profile_avatar.size.' . $xSize)) {
                $xSize = $sRealSize;
            ...
            if ($iSize = (int)$xSize) {
                ...
                if (\C::get('module.image.autoresize') && !F::File_Exists($sResizePath)) {
                    $sResizePath = \E::Module('Img')->autoResizeSkinImage($sResizePath, 'avatar_blog', $iSize ? $iSize : null);
                }
            }
        }
        if ($sResizePath) {
            ...
            $sPath = \E::Module('Img')->autoResizeSkinImage($sPath, 'avatar_blog', null);
        }
    ...
    public function getCurrentUserRole() {
        ...
        return (int)$this->getProp('_user_role');
    }
    ...
    public function getLink()
    {
        ...
        return R::getLink('blog/' . $this->getUrl());
    }
    ...
    public function canEditedBy($oUser) {
        ...
        return $oUser && \E::Module('ACL')->isAllowEditBlog($this, $oUser);
    }
    ...
    public function canAdminBy($oUser) {
        ...
        return $oUser && \E::Module('ACL')->isAllowAdminBlog($this, $oUser);
    }
    ...
    public function canDeletedBy($oUser) {
        ...
        return $oUser && \E::Module('ACL')->isAllowDeleteBlog($this, $oUser);
    }
    ...
    public function canReadBy($oUser) {
        ...
        return $oUser && \E::Module('ACL')->isAllowShowBlog($this, $oUser);
    }
