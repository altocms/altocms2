...
class ModuleApi extends Module {
    ...
    public function setLastError($aError) {
        ...
        \E::Module('Cache')->setTmp($aError, 'MODULE_API_LAST_ERROR');
    }
    ...
    public function getLastError() {
        ...
        return \E::Module('Cache')->getTmp('MODULE_API_LAST_ERROR');
    }
    ...
    public function apiUserIdInfo($aParams) {
        ...
        if (!($oUser = \E::Module('User')->getUserById($aParams['uid']))) {
            return FALSE;
        }
    ...
    public function apiBlogIdInfo($aParams) {
        ...
        if (!($oBlog = \E::Module('Blog')->getBlogById($aParams['uid']))) {
            return FALSE;
        }
    ...
    public function apiTopicIdRating($aParams) {
        ...
        if (!($oTopic = \E::Module('Topic')->getTopicById($aParams['tid']))) {
            return FALSE;
        }
