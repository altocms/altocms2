 ...
 * @method string   getContentTitle()
 * @method string   getContentTitleDecl()
 * @method string   getContentUrl()
 * @method bool     getContentCandelete()
 * @method bool     getContentAccess()
 *
...
class ModuleTopic_EntityContentType extends Entity
{
    ...
    public function getFields()
    {
        if (is_null($this->aFields)) {
            ...
            $this->aFields = \E::Module('Topic')->getContentFields($aFilter);
        }
        return $this->aFields;
    }
    ...
    public function getTemplate($sMode = null) {
        ...
        if (!$sTemplate) {
            ...
            if (!\E::Module('Viewer')->templateExists('topics/' . $sTemplate)) {
    ...
    public function setExtra($data) {
        ...
        $this->aProps['content_config'] = serialize($data);
    }
    ...
    public function isAccessible() {
        ...
        if ($oUser = \E::User()) {
            if ($this->getContentAccess() == ModuleTag::CONTENT_ACCESS_ONLY_ADMIN && !$oUser->isAdministrator()) {
                return false;
            } else {
                return true;
            }
